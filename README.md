...
<a href="https://dash.elest.io/deploy?source=cicd&social=dockerCompose&url=https://github.com/elestio-examples/docker-compose-metabase"><img src="deploy-on-elestio.png" alt="Deploy on Elest.io" width="180px" /></a>
...
But for these Metabase examples, you can choose Docker compose as your deployment method.

### Step 3: Select Docker compose example

After selecting a deployment select Metabase as your docker-compose example
